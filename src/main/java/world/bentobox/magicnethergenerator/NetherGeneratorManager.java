...
/**
 * This class provides some helper methods to clean up NetherGeneratorAddon class.
 */
public class NetherGeneratorManager
{
    /**
     * Default constructor.
     *
     ...
     */
    public NetherGeneratorManager(NetherGeneratorAddon addon)
    {
        this.addon = addon;
    ...
    /**
     * This method returns if Nether generator should operate in given world.
    ...
    /**
     * This variable holds addon names where nether generator should work.
     */
